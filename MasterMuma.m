...
[xi, yi, Exi, Eyi, Ezi] = focalFields(lambda, NA, 0, 0.05, FocalLength, pi/dqx(2), 2*N-1);
...
% [ff, f00fkx] = SpinWaveGreen(qx+0.0001, 0.55, hNiFe, length(qx), 40);
...
%     Mx = zeros(size(My));
    ...
    FFTtruncYI = FFTtruncY(:,:,i);
    FFTtruncZI = FFTtruncZ(:,:,i);
